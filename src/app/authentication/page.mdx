...
export const metadata = {
  ...
  description:
    'Learn how to authenticate Power Platform ToolBox with your Dataverse environments using interactive login, OAuth app registration, or username/password.',
}
...
export const sections = [
  ...
  { title: 'Multiple Connections', id: 'multiple-connections' },
...
Connect Power Platform ToolBox to your Dataverse environments securely. This guide covers all authentication methods, security features, and best practices. {{ className: 'lead' }}

## Authentication Methods {{ anchor: true }}
...
1. In Power Platform ToolBox, open the Connections panel and select Add
...
## Managing Connections {{ anchor: true }}
...
## Multiple Connections {{ anchor: true }}
...
[![PPTB Configure multiple connections](images/screenshots/authentication-multiconnections.png)](images/screenshots/authentication-multiconnections.png)
...
[![PPTB Configure multiple connections colours](images/screenshots/authentication-multiconnections2.png)](images/screenshots/authentication-multiconnections2.png)
