export const metadata = {
  title: 'ToolBox Development — Desktop App',
  description: 'Get started with Power Platform ToolBox Desktop App (Electron) development - setup, build, and contribute to the core application',
}
...
<div className="not-prose mb-16 mt-6 flex gap-3">
  <Button href="/toolbox-development/desktop/architecture" arrow="right">
    <>Architecture Guide</>
  </Button>
