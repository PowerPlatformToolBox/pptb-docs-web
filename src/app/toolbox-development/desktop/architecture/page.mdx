export const metadata = {
  title: 'Architecture — Desktop App',
  description: 'Understanding the architecture of the Power Platform ToolBox Desktop App (Electron) - components, data flow, and design patterns',
}
