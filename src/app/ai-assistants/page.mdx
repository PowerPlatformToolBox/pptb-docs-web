...
export const sections = [
  ...
  { title: 'Guided Tool Runs', id: 'guided-tool-runs' },
...
| --- | --- | --- |
| Guided tool run | The tool opens its normal UI and the assistant works with that interactive experience | Pickers, review screens, confirmation steps, anything where a person should stay in the loop |
...
## Guided Tool Runs {{ anchor: true }}

In a guided tool run, the assistant launches the tool the same way a person would, with the tool interface visible inside PPTB.
...
- Some tools ask for user interaction and are better suited to guided runs.
...
<Note type="information">
  ...
  explains whether it supports guided runs, automated runs, or both.
</Note>
