export const metadata = {
  title: 'Quick Start',
  description:
    'Get started with Power Platform ToolBox in minutes - download, install, and connect to your Power Platform environment.',
}

export const sections = [
  { title: 'Step 1: Download and Install', id: 'step-1-download-and-install' },
  { title: 'Step 2: Connect to Power Platform', id: 'step-2-connect-to-power-platform' },
  { title: 'Step 3: Install Your First Tool', id: 'step-3-install-your-first-tool' },
  { title: "What's Next?", id: 'whats-next' },
]

# Quick Start

Get up and running with Power Platform ToolBox in just a few minutes. This guide covers installation, connecting to your Power Platform environment, and installing your first tool. {{ className: 'lead' }}

## Step 1: Download and Install based on your operating system: {{ anchor: true }}
...
<Note type="warning">
  **⚠️ macOS Users:** If you see a 'damaged' or 'unidentified developer' warning
  ...
  "/Applications/Power Platform ToolBox.app" ```
</Note>

<Note type="important">
  Power Platform ToolBox requires Node.js 18+ for tool execution. It will be
  automatically detected or you can configure the path in Settings.
</Note>

## Step 2: Connect to Power Platform {{ anchor: true }}
...
## Step 3: Install Your First Tool {{ anchor: true }}
...
- Review the [package manifest](/tool-development#define-package.json) for required fields
