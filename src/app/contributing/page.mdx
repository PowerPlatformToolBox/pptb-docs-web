export const metadata = {
  title: 'Contributing',
  description: 'Learn how to contribute to Power Platform ToolBox - guidelines for PRs, commits, and collaboration',
}
...
Thank you for your interest in contributing to Power Platform ToolBox! This guide will help you understand our contribution process and requirements. {{ className: 'lead' }}

## Code of Conduct {{ anchor: true }}
...
## PR Requirements Summary {{ anchor: true }}
...
**Thank you for contributing to Power Platform ToolBox!** 🚀
