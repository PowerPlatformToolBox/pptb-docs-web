...
<Note>
  If you are contemplating re-imagining an existing tool in the XrmToolBox,
  please (if you are not the author!) reach out to the original author to
  discuss collaboration opportunities before starting development.
</Note>

<Note>
  We strongly encourage collaboration on tools. Our Discord community should be
  your first stop for discussing ideas, seeking help, and sharing your work with
  others: https://discord.gg/yHXdyuqWva
</Note>
