export const metadata = {
  title: 'API Reference',
  description:
    'Complete API reference for ToolBox API, PowerPlatform API, and Dataverse API available to tool developers',
}
...
Comprehensive reference for the ToolBox API, PowerPlatform API, and Dataverse API available to all tools running in Power Platform ToolBox. {{ className: 'lead' }}
...
<div className="not-prose my-16 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
  ...
  <div className="relative rounded-2xl border border-zinc-900/5 p-6 dark:border-white/5">
    ...
    <div className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
      Direct access to Power Platform management and service endpoints
    </div>
    <div className="mt-4">
      <Button href="/tool-development/api-reference/powerplatform-api" variant="text" arrow="right">
        View Documentation
      </Button>
    </div>
  </div>
...
3. **[PowerPlatform API](/tool-development/api-reference/powerplatform-api)** - Call Power Platform service endpoints
4. **[Dataverse API](/tool-development/api-reference/dataverse-api)** - Start interacting with Dataverse
5. **[Error Handling](/tool-development/api-reference/error-handling)** - Implement robust error handling
