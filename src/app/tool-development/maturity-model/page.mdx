...
| Reviews | At least 1 rated 3 or above | A real user has provided a positive-enough trust signal (submitted via the desktop app [in-app rating feature](/tool-installation#rating-tools)). |
