export const metadata = {
  ...
  description:
    'Expose your PPTB tool to AI assistants through MCP, support guided and automated tool runs, and return structured results safely.',
}

export const sections = [
  { title: 'Overview', id: 'overview' },
  { title: 'MCP Contract', id: 'mcp-contract' },
  { title: 'Guided and Automated Runs', id: 'guided-and-automated-runs' },
...
## Guided and Automated Runs {{ anchor: true }}

These docs use end-user language for the two execution styles:

| User-facing term | MCP runtime value | Meaning |
| --- | --- | --- |
| Guided tool run | `executionMode: "windowed"` | PPTB opens the tool UI and the assistant works through the normal interactive experience |
...
Guided runs are a good fit for existing UI-driven tools. Automated runs are a good fit for repeatable tasks, direct data returns, and unattended workflows.
...
If your tool supports both guided and automated runs, keep the contract aligned across both paths.
